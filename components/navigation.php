<nav class="fixed w-full z-50 flex justify-between items-center py-5 px-6 bg-gray-800 top-0 left-0">
    ...
    <ul class="flex space-x-6">
        <li>
            <a href="./contact.php" class="text-2xl font-suse text-white  hover:bg-[#35EAFF] py-2 px-4 rounded transition duration-300">
                Contact
            </a>
        </li>
        <li>
            <a href="./login.php" class="text-2xl font-suse text-white  hover:bg-[#35EAFF] py-2 px-4 rounded transition duration-300">
                Login
            </a>
        </li>
    </ul>
